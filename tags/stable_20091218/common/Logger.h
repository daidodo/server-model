...
#       define GLOBAL_LOGGER1(logger,header,expr)   GLOBAL_LOGSYS_FOCUS(logger,header,expr)
#       define LOCAL_LOGGER1(logger,header,expr)    LOCAL_LOGSYS_FOCUS(logger,header,expr)
#       define SCOPE_LOGGER1(logger,header,expr)    SCOPE_LOGSYS_FOCUS(logger,header,expr)
...
#       define LOCAL_LOGGER1(logger,header,expr)
