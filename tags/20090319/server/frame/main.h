...
static CMainServer * mainServer = 0;

static const int _SIG_SHOW_CONFIG = SIGRTMIN + 13; //显示配置信息信号

static const int _SIG_RECONFIG = SIGRTMIN + 14;    //重读配置文件信号

static const int _SIG_EXIT = SIGRTMIN + 15;        //正常退出信号
...
static void registerSignal()
{
    ...
    if(signal(_SIG_EXIT,exitNormally) == SIG_ERR)
        cerr<<"register _SIG_EXIT signal failed"<<endl;
}
